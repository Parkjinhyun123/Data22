...
import chevronRighttIcon from "../assets/icon/chevron_right_ff9b50.png";

function Modal({ isOpen, onClose, onSendData }) {
        ...
        <div className="modal-container">
          ...
          <div className="modal-content">
                  ...
                  <>
                    ...
                    {showChevron && (
                      <>
                        ...
                        >
                          <img src={chevronRighttIcon} alt="right-chevron" />
                        </div>
                      </>
                    )}
                  </>
            ...
            <div className="modal-contentBox">
              ...
              <Button onSendData={handleSendData}>등록하기</Button>
            </div>
          </div>
        </div>
      </div>
