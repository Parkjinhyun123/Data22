...
import CustomerServiceDog from "../assets/gallery/CustomerServiceDog.png";
...
const styles = {
  ...
  height: "40vh",
  zIndex: 2,
  // 이미지 예시입니다. CSS 수정 예정 백그라운드 이미지로 쓰면 좀 더 깔끔하게 나올듯요
  // 때에 따라 삭제할 수 있음 일단 임시.
};
  ...
  return (
    <div className="main-container">
      <div className="img-container">
        <img src={CustomerServiceDog} style={styles} />
      </div>
